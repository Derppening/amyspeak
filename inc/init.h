...
std::unique_ptr<std::vector<std::vector<std::string>>> ParsePatterns(std::ifstream &input_file,
                                                                     const std::unique_ptr<std::map<std::string,
...
std::unique_ptr<std::vector<std::pair<std::size_t,
                                      std::string>>> ParseTokenCategories(const std::vector<std::string> &in);
std::unique_ptr<std::map<std::string, std::vector<std::string>>> ConstructMatchingTokens(
    const std::vector<std::string> &tokens,
    const std::vector<std::pair<std::size_t, std::string>> &token_cat);
std::unique_ptr<std::map<std::string, std::vector<std::string>>> ConstructVerbToken(
    const std::vector<std::string> &tokens, std::size_t start_pos);
